      ...
      <div className="space-y-5 px-4">
        ...
        {building.syndic && (
          <div className="card flex items-center gap-3 p-3.5">
            ...
            <a href={`https://wa.me/${building.syndicPhone.replace(/\s/g, "").replace(/^0/, "212")}`} target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full bg-palier-100">
