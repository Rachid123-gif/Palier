          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                const html = `<!DOCTYPE html><html lang="${isAr ? "ar" : "fr"}" dir="${isAr ? "rtl" : "ltr"}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${isAr ? "تصدير بياناتي" : "Export de mes données"} — Palier</title><style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;max-width:720px;margin:0 auto;padding:24px 20px 48px;color:#374151;background:#fff}.print-btn{display:inline-flex;align-items:center;gap:6px;margin-top:12px;padding:10px 20px;background:#1e5b50;color:#fff;border:none;border-radius:10px;font-size:14px;font-weight:600;cursor:pointer}.print-btn:active{opacity:0.8}@media print{.print-btn{display:none!important}body{padding:0}}</style></head><body>
<div style="margin-bottom:32px">
  ...
  <button class="print-btn" onclick="window.print()">🖨 ${isAr ? "طباعة / حفظ PDF" : "Imprimer / Sauvegarder en PDF"}</button>
</div>
