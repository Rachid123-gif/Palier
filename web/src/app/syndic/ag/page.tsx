      ...
      <div className="animate-[fade_0.3s_ease]">
        ...
        <Card>
          <div className="flex items-center gap-3 p-4">
            ...
            <p className="text-[13px] text-ink-soft">Aucune assemblée générale programmée. Créez une convocation pour commencer.</p>
          </div>
        </Card>
      </div>
    );
  ...
  return (
    <div className="animate-[fade_0.3s_ease]">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
        <KpiCard icon="CalendarDays" label="Prochaine AG" value={longDate(ag.date)} tint="bg-palier-100" color="text-palier-600" />
        <KpiCard icon="Users" label="Quorum atteint" value={`${ag.quorum}%`} tint="bg-success-soft" color="text-success" hint="présents + pouvoirs" />
        <KpiCard icon="Vote" label="Votes ouverts" value={String(ag.votes.length)} tint="bg-info-soft" color="text-info" />
      </div>
