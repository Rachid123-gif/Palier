  ...
  return (
    <div className="min-h-dvh bg-cream antialiased">
      ...
      <main className="mx-auto max-w-3xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <p className="mt-2 text-[14px] text-ink-faint">Dernière mise à jour : août 2026</p>

        <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-ink-soft">
          {/* 1. Responsable */}
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">1. Responsable du traitement</h2>
            <p>
              Le responsable du traitement des données est <strong>Palier</strong>, joignable à l&apos;adresse{" "}
              <a href="mailto:contact@palier.ma" className="text-palier-600 underline">contact@palier.ma</a>.
            </p>
          </section>

          {/* 2. Données collectées */}
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">2. Données collectées</h2>
            <p>Dans le cadre de l&apos;utilisation de la plateforme, nous collectons les données suivantes :</p>

            <p className="mt-3 font-semibold text-ink">Données d&apos;identification</p>
            ...
            <p className="mt-3 font-semibold text-ink">Données d&apos;usage et contenu</p>
            <ul className="mt-1 list-disc space-y-1 pl-5">
            ...
            <p className="mt-3 font-semibold text-ink">Données financières</p>
            <ul className="mt-1 list-disc space-y-1 pl-5">
              <li>Montants des charges et appels de fonds</li>
              <li>Paiements enregistrés (montant, méthode de paiement, date)</li>
            </ul>

            <p className="mt-3 font-semibold text-ink">Données techniques</p>
            <ul className="mt-1 list-disc space-y-1 pl-5">
          ...
          {/* 3. Finalité */}
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">3. Finalité du traitement</h2>
          ...
          {/* 4. Base légale */}
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">4. Base légale</h2>
            <p>
          ...
          {/* 5. Sous-traitants */}
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">5. Sous-traitants et services tiers</h2>
          ...
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">6. Transferts internationaux de données</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">7. Durée de conservation</h2>
            <p>
          ...
          {/* 8. Vos droits */}
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">8. Vos droits</h2>
          ...
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">9. Réclamation auprès de la CNDP</h2>
            <p>
              ...
              (<a href="https://www.cndp.ma" target="_blank" rel="noopener noreferrer" className="text-palier-600 underline">www.cndp.ma</a>).
            </p>
          </section>

          {/* 10. Mesures de sécurité */}
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">10. Mesures de sécurité</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">11. Cookies et stockage local</h2>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li>
                <strong>Cookie de session</strong> (<code className="rounded bg-sand px-1.5 py-0.5 text-[13px]">palier_session</code>)
                {" "}— marqué <code className="rounded bg-sand px-1.5 py-0.5 text-[13px]">httpOnly</code>, contient l&apos;identifiant
                de session chiffré. Strictement nécessaire à l&apos;authentification.
              </li>
              <li>
                <strong>Cookie d&apos;accès bêta</strong> (<code className="rounded bg-sand px-1.5 py-0.5 text-[13px]">palier_beta</code>)
                {" "}— marqué <code className="rounded bg-sand px-1.5 py-0.5 text-[13px]">httpOnly</code>, durée 365 jours.
          ...
          <section>
            <h2 className="mb-2 text-[18px] font-bold text-ink">12. Références juridiques</h2>
            <p>
