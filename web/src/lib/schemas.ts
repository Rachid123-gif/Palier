...
export const saveBuildingSettingsSchema = z.object({
  ...
  auto_relance_frequency_days: z.number().int().min(1).max(60).optional(),
  auto_receipt_enabled: z.boolean().optional(),
  ...
  gardien_nuit: z.object({
    name: shortString,
    phone: z.string().max(20),
    horaires: z.record(z.string(), z.object({ de: z.string(), a: z.string(), repos: z.boolean() })),
    taches: z.array(shortString),
  }).nullable().optional(),
  has_two_gardiens: z.boolean().optional(),
